...
class BusInfosTable(models.Model):
    ...
    bus_id_number = models.CharField(
        max_length=200,
        null=True,
    )
...
class SeatsTable(models.Model):
    ...
    status = models.IntegerField(null=True, choices=SEAT_STATUS)
...
class BookingTable(models.Model):
    ...
    pick_up = models.ForeignKey("PickUpsTable", on_delete=models.CASCADE, null=True)
